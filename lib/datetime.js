...
// Today's calendar date (YYYY-MM-DD) in a given IANA zone. Used so "today"
// rolls over at local midnight (e.g. Mountain time) rather than at UTC
// midnight, which would flip the date mid-evening for U.S. users.
export function todayStr(timeZone = "America/Denver") {
